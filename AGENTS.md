# Worker Instructions — mainstem-before-neighbors
...
- src/dgov/cli/worker_cmd.py
- src/dgov/done.py

- **Also check:** src/dgov/persistence.py
- **Also check:** src/dgov/waiter.py
...
Hints:
- Run post-merge lint and related tests after changes.
